...
public class GCash_GSave {
	...
	public static By objContinue = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/next_message']");
	public static By objMySavingAcc=By.xpath("//android.widget.TextView[@text='My Savings Account']");
	public static By objDepositBtn=By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/btn_deposit']");
	public static By objDepositePage=By.xpath("//android.widget.TextView[@text='Deposit']");
	public static By objAmountTextField=By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/txt_amount']");
	...
	public static By objAmtPhp = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/tvAmount']");
	...
	public static By objTotalSavingBalance = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/txtBalance']");
	public static By objAccountNo = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/txtAccNumber']");
	public static By objInterestRate = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/txtInterestRate']");
	public static By objCIMBBankLogo = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/ivHolder']");
	public static By objGCashAmt = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/tvGcashAmt']");
	public static By objErrorMsg = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/tvCustomHeader']");
	public static By objGSaveAccountBalance = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/tvGSaveValue']");
	public static By objOOps = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/alertTitle']");
	public static By objOkBtns = By.xpath("//*[@resource-id='android:id/button1']");
	...
	//Phone Number
	public static By objPhoneNo = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/txt_number']");
	...
	public static By objGSaveMarketPlaceBackBtn = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/h5_tv_nav_back']");
	public static By bjMarketBack = By.xpath("//*[@resource-id='com.globe.gcash.android.uat.tokyo:id/h5_nav_back']");
}
